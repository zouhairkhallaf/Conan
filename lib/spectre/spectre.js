...
function handler (request, reply) {
    ...
    db.collection('messages').aggregate([
      ...
      {   $lookup : { from: "components",
                      ...
                      foreignField: "_id",
                      as: "ENVELOPE"}},
      {   $project: { "ENVELOPE.modifiedAt":0, "ENVELOPE.createdAt":0, "ENVELOPE.owner": 0 , "ENVELOPE.creator": 0, "ENVELOPE.__v": 0, "ENVELOPE.creator": 0}},
      {   $lookup : { from: "components",
      ...
      {   $lookup : { from: "components",
                      ...
                      foreignField: "_id",
                      as: "STATIONERY"}},
      {   $project: { "STATIONERY.modifiedAt":0, "STATIONERY.createdAt":0, "STATIONERY.owner": 0 , "STATIONERY.creator": 0, "STATIONERY.__v": 0, "STATIONERY.creator": 0}},
